...
  }
    ...
    const prevSlide = (diffcusine) => {
        setCurrentIndex((prevIndex) =>
            prevIndex === 0 ? diffcusine.length - 7 : prevIndex - 1
        );
    ...
    const nextSlide = (diffcusine) => {
        setCurrentIndex((prevIndex) =>
            prevIndex === diffcusine.length - 7 ? 0 : prevIndex + 1
        );
        diffcusine[diffcusine.length - 1] = (diffcusine[diffcusine.length - 1] === diffcusine.length - 7 ? diffcusine.length - 7 : diffcusine[diffcusine.length - 1] + 1)
    };
                        ...
                        <div className=' '>
                            {
                                diffcusine.length > 0 ? <div className='p-3 text-center'>
                                    ...
                                    <div key={ind} className='flex flex-grow'>
                                        <button onClick={() => prevSlide(diffcusine)}>
                                            <BsChevronLeft />
                                        </button>
                                        <div className='flex gap-2' style={{ backgroundSize: "cover" }} >
                                            {diffcusine.slice(diffcusine[diffcusine.length - 1], diffcusine[diffcusine.length - 1] + 6).map((item, index) => (
